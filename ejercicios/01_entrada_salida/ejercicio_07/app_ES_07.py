...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert(title='Ejercicio 07',message=f'El resultado de la suma es {resultado}.')
    ...
    def btn_restar_on_click(self):
        ...
        numero2 = self.txt_operador_b.get()
        resultado = int(numero1) - int(numero2)
        alert(title='Ejercicio 07',message=f'El resultado de la resta es {resultado}.')
    ...
    def btn_multiplicar_on_click(self):
        ...
        numero2 = self.txt_operador_b.get()
        resultado = int(numero1) * int(numero2)
        alert(title='Ejercicio 07',message=f'El resultado de la multiplicación es {resultado}.')
    ...
    def btn_dividir_on_click(self):
        ...
        alert(title='Ejercicio 07',message=f'El resultado de la división es {resultado}.')
